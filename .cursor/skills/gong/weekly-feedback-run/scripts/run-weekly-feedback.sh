...
RUN_DIR="$GONG_SUMMARY_DIR/data/runs/$RUN_ID"
...
MANIFEST_PATH="$GONG_SUMMARY_DIR/data/runs/$RUN_ID/manifest.json"
echo ""
...
echo "  3) Sync this weekly run to Notion via MCP:"
echo "     RUN_ID=$RUN_ID node scripts/push-to-notion.mjs"
echo "  4) Optional: publish this week's result as canonical feedback.json:"
